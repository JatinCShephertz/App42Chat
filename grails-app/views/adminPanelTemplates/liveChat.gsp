...
<div class="row mrlrtp" ng-repeat="widget in widgets"  ng-if="$index % 4 == 0">

  <div class="col-md-3" id="appwarpchatWidget{{widgets[$index].name}}">
    <!-- DIRECT CHAT PRIMARY -->
        ...
        <div class="direct-chat-messages" id="chatBox{{widgets[$index].name}}" >
          <div ng-repeat="obj in widgets[$index].messages">
            <div ng-if="obj.position" class="direct-chat-msg" >
              ...
              <img class="direct-chat-img" src="${request.getContextPath()}/images/app42chatadmin/avatar04.png" alt="message user image"><!-- /.direct-chat-img -->
  ...
  <div  class="col-md-3" ng-if="widgets.length > ($index + 1)" id="appwarpchatWidget{{widgets[$index+1].name}}">
    <!-- DIRECT CHAT PRIMARY -->
    <div class="box box-primary direct-chat direct-chat-primary">
      <div class="box-header with-border">
  ...
  <div  class="col-md-3" ng-if="widgets.length > ($index + 2)" id="appwarpchatWidget{{widgets[$index+2].name}}">
    <!-- DIRECT CHAT PRIMARY -->
    <div class="box box-primary direct-chat direct-chat-primary">
      <div class="box-header with-border">
